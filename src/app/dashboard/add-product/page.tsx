      ...
      <div className="min-h-screen" style={{ backgroundColor: '#faf8f5' }}>
        <div className="border-b py-6 md:py-8" style={{ backgroundColor: '#f5efe6', borderColor: '#e8dfd0' }}>
          <div className="max-w-4xl mx-auto px-4 md:px-6">
            <Link href="/dashboard" className="text-xs md:text-sm mb-3 md:mb-4 inline-block" style={{ color: '#926829' }}>
              ← Back to Dashboard
            </Link>
            <h1 className="text-3xl md:text-4xl font-bold" style={{ fontFamily: 'Georgia, serif', color: '#926829' }}>
              Become an Artisan
            </h1>
            <p className="text-sm md:text-base text-gray-600 mt-2">Start selling your handcrafted products</p>
          </div>
        </div>

        <div className="max-w-2xl mx-auto px-4 md:px-6 py-12 md:py-20">
          <div className="bg-white rounded-2xl shadow-lg border-2 p-8 md:p-12 text-center" style={{ borderColor: '#e8dfd0' }}>
            <div className="text-6xl md:text-7xl lg:text-8xl mb-4 md:mb-6">🎨</div>
            <h2 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4" style={{ color: '#926829' }}>
            ...
            <div className="bg-gray-50 rounded-xl p-5 md:p-6 mb-6 md:mb-8" style={{ backgroundColor: '#f5efe6' }}>
              <h3 className="font-bold text-base md:text-lg mb-3 md:mb-4" style={{ color: '#926829' }}>
                Benefits of Becoming an Artisan:
              </h3>
              <ul className="text-left space-y-2 text-sm md:text-base text-gray-700">
            ...
            <Link href="/become-artisan">
              <button className="px-8 md:px-10 py-3 md:py-4 text-white rounded-xl font-bold text-base md:text-lg transition-all duration-300 transform active:scale-95 md:hover:scale-105 shadow-lg"
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#faf8f5' }}>
      <div className="border-b py-6 md:py-8" style={{ backgroundColor: '#f5efe6', borderColor: '#e8dfd0' }}>
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          ...
          <p className="text-sm md:text-base text-gray-600 mt-2">Share your handcrafted creation with the world</p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 md:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 pt-3 md:pt-4">
              <button
                ...
                className="flex-1 py-3 md:py-4 text-white rounded-xl font-bold text-base md:text-lg transition-all duration-300 transform active:scale-95 md:hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                style={{ backgroundColor: '#926829', minHeight: '48px' }}
              ...
              <Link href="/dashboard" className="flex-1">
                <button
                  type="button"
                  className="w-full py-3 md:py-4 border-2 rounded-xl font-bold text-base md:text-lg transition-all duration-300 active:scale-95 md:hover:scale-105"
