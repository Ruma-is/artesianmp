...
export default function ProductTabs({ description }: ProductTabsProps) {
  ...
  return (
    <div className="mt-8 md:mt-12 animate-fade-in-delay-2">
      {/* Tab Headers */}
      <div className="flex gap-1 md:gap-2 border-b-2 mb-4 md:mb-6 overflow-x-auto" style={{ borderColor: '#e8dfd0' }}>
        {tabs.map((tab) => (
          <button
            key={tab.id}
            onClick={() => setActiveTab(tab.id)}
            className={`px-3 sm:px-4 md:px-6 py-2 md:py-3 font-semibold transition-all duration-300 relative whitespace-nowrap text-xs sm:text-sm md:text-base ${
              activeTab === tab.id 
                ? 'text-white' 
      ...
      {/* Tab Content */}
      <div className="p-4 md:p-6 bg-white rounded-xl shadow-lg border-2 min-h-[200px]" style={{ borderColor: '#e8dfd0' }}>
        {activeTab === 'description' && (
          <div className="animate-fade-in">
            <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4" style={{ fontFamily: 'Georgia, serif', color: '#926829' }}>
              About This Product
            </h3>
            ...
            <div className="mt-4 md:mt-6 p-3 md:p-4 rounded-lg" style={{ backgroundColor: '#f5efe6' }}>
        ...
        {activeTab === 'details' && (
          <div className="animate-fade-in">
            ...
            <div className="space-y-2 md:space-y-3">
              <div className="flex justify-between py-2 border-b text-sm md:text-base" style={{ borderColor: '#e8dfd0' }}>
                <span className="font-semibold text-gray-700">Material:</span>
                <span className="text-gray-600 text-right">Premium Natural Materials</span>
              </div>
              <div className="flex justify-between py-2 border-b text-sm md:text-base" style={{ borderColor: '#e8dfd0' }}>
              ...
              <div className="flex justify-between py-2 border-b text-sm md:text-base" style={{ borderColor: '#e8dfd0' }}>
                ...
                <span className="text-gray-600 text-right">Handle with care, clean gently</span>
              </div>
              <div className="flex justify-between py-2 border-b text-sm md:text-base" style={{ borderColor: '#e8dfd0' }}>
        ...
        {activeTab === 'reviews' && (
          <div className="animate-fade-in">
            ...
            <div className="text-center mb-4 md:mb-6">
              <div className="text-3xl md:text-4xl lg:text-5xl font-bold mb-2" style={{ color: '#926829' }}>4.8</div>
              <div className="text-yellow-500 text-xl md:text-2xl mb-2">⭐⭐⭐⭐⭐</div>
              <p className="text-gray-600 text-sm md:text-base">Based on 127 reviews</p>
            </div>
            ...
            <div className="space-y-3 md:space-y-4 mt-4 md:mt-6">
              {[
                ...
                <div key={idx} className="p-3 md:p-4 rounded-lg border" style={{ borderColor: '#e8dfd0', backgroundColor: '#faf8f5' }}>
